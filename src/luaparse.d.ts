...
export interface Options {
  ...
  /**
   * The version of Lua the parser will target; supported values are '5.1', '5.2', '5.3' and
   * 'LuaJIT'.
   */
   ...
   * Note: setting luaVersion: 'LuaJIT' currently does not enable this option; this may change in
   * the future.
   */
